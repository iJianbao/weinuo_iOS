...
@interface GaodushezhiViewController : GCUIViewController<UITableViewDelegate, UITableViewDataSource,UINavigationControllerDelegate,UIAlertViewDelegate,UITextFieldDelegate> {
