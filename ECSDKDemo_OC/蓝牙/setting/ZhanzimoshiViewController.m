...
@implementation ZhanzimoshiViewController
...
- (void)RightBarButtonItemPressed
{
    ...
    [BLEManager sharedManager].yy_zhanziInfo = [NSString stringWithFormat:@"%f", saveHeight + 0.00001];
    [self.navigationController popViewControllerAnimated:YES];
}
...
//    m_txtUserName.text= _strName;
    ...
    NSString *zhanzigaodu = [BLEManager sharedManager].yy_zhanziInfo;
    if(zhanzigaodu != nil && zhanzigaodu.length > 0) {
        NSArray *zhanziArray = [zhanzigaodu componentsSeparatedByString:@"#"];
        m_txtUserName.placeholder = [BLEManager floatHeight:[BLEManager autoInOrCm:[zhanziArray.firstObject floatValue]
