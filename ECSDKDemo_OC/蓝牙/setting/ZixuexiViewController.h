...
#import "BLEManager.h"
@interface ZixuexiViewController : GCUIViewController<BLEManagerDelegate,UITableViewDelegate, UITableViewDataSource,UINavigationControllerDelegate,UIAlertViewDelegate,UITextFieldDelegate> {
